...
%
%Galaxies are often found near other galaxies.  Due to gravitational forces pulling them together, galaxies tend to clump.  Galaxies can be found in environments ranging from near complete isolation all the way up to large clusters of thousands of galaxies.  This clustering can often be correlated with other galaxy properties.  While there are always exceptions, we tend to find redder elliptical galaxies in more clustered environments, while bluer spirals are often more isolated.
...
%---------------------------------------------------
%\subsubsection{Accretion Disks and Relativistic Jets}

%!!! Add content about observations.
...
%---------------------------------------------------
%\subsubsection{Where are these correlations valid?}

%!!! Add content about where these correlations are valid.
