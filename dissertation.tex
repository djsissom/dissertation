...
\begin{center}
	...
	Early Growth in a Perturbed Universe:\\
	Exploring Dark Matter Halo Populations in \lpt\ and \za\ Simulations\par
	\vskip.5in
	By
	\vskip .3in
	{Daniel J. Sissom}
...
%\rule{4.0in}{.5pt} \hskip 0.1in \rule{1.5in}{.5pt} \\J. Kelly Holley-Bockelmann, Ph.D.\\[.15in]
...
\begin{doublespace}
Approved:\\[.15in]
J. Kelly Holley-Bockelmann, Ph.D.\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\chapter*{ACKNOWLEDGMENTS} %%%%%%%%% put this back!
...
\input{chapters/smbhs/content/preface}
...
\begin{appendices}
	...
	\lstinputlisting[language=Python]{chapters/appendices/content/mass_trends/fit_trends.py}
